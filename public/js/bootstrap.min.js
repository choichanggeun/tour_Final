                      ...
                      value: function () {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                          ...
                          a(e).data(this.constructor.DATA_KEY, this).appendTo(document.body),
                            ...
                            (this._tether = new Tether({ attachment: j, element: e, target: this.element, classes: s, classPrefix: k, offset: this.config.offset, constraints: this.config.constraints, addTargetClasses: !1 })),
                            f.reflow(e),
